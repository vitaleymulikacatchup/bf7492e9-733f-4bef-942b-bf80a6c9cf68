...
export const metadata: Metadata = {
  title: "RentHub - Premium Rental Home Platform",
  description: "Find verified rental homes from trusted hosts. Book your perfect vacation rental or list your property on our premium platform today.",
  keywords: "rental homes, vacation rentals, property rental, Airbnb alternative, vacation home booking",
  metadataBase: new URL("https://renthub.com"),
  alternates: {
    canonical: "https://renthub.com"
  },
  openGraph: {
    title: "RentHub - Premium Rental Home Platform",
    description: "Find verified rental homes from trusted hosts. Book your perfect vacation rental or list your property today.",
    siteName: "RentHub",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/5997993/pexels-photo-5997993.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Beautiful rental home with modern amenities"
      }
    ]
  },
  twitter: {
    ...
    title: "RentHub - Premium Rental Home Platform",
    description: "Find verified rental homes from trusted hosts worldwide",
    images: ["https://images.pexels.com/photos/5997993/pexels-photo-5997993.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
